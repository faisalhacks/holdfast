...
export const DEFAULT_NOISE_TOKENS: ReadonlySet<string> = new Set([
  ...
  'mmt',
  'clg',
  // party identifiers and account masks. A GSTIN names WHO was paid, not WHICH document,
  // and `xxxx` is the masked account number a statement prints beside it. Both used to
  // reach the vendor residue as words and the reference lane as candidates; a line that
  // named the vendor twice was passing as a line that named the invoice.
  'gstin',
  'gstno',
  'gstn',
  'tin',
  ...
  'xxxx',
  'na',
  // date furniture. Six digits of `VALUE DT 23-05-26` are six digits that will contain
